...
graph_dir <- "E:/CR2/Repos/TNC-Demand-Model-Southeast/OTP"
...
# path_otp <- paste0(getgraph_dir(), "/", "otp-1.4.0-shaded.jar")
# path_data <- graph_dir
...
centroids <- read.csv(paste0(graph_dir, "/centroid_points.csv"))[, -1]
